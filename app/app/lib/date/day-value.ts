...
export function todayDayValue(now: Date = new Date()): string {
...
export function parseDayValue(value?: string | null): Date | null {
...
export function dayValueToIso(value?: string | null): string | null {
